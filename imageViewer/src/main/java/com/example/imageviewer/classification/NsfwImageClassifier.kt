...
internal class NsfwImageClassifier(
    ...
    modelPath: String = ClassifierConfig.NSFW_MODEL_PATH
) : ImageClassifier {

    private val safetyRules = ClassifierConfig.NSFW_SAFETY_RULES

    private val inputWidth = ClassifierConfig.INPUT_IMAGE_WIDTH
    private val inputHeight = ClassifierConfig.INPUT_IMAGE_HEIGHT
