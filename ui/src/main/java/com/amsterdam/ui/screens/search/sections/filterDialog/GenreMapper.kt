package com.amsterdam.ui.screens.search.sections.filterDialog
...
val mediaGenres: Map<GenreType, Genre> = mapOf(
    ...
    GenreType.HISTORY to Genre(GenreType.HISTORY, R.drawable.ic_cat_history, R.string.history),
    GenreType.HORROR to Genre(GenreType.HORROR, R.drawable.ic_cat_horror, R.string.horror),
    ...
    GenreType.WESTERN to Genre(GenreType.WESTERN, R.drawable.ic_cat_western, R.string.western),
)


@Composable
fun getGenreLabel(genreType: GenreType): String {
    return stringResource(mediaGenres[genreType]?.displayableName ?: R.string.all)
}

@Composable
fun getGenreIcon(genreType: GenreType): Painter {
    return painterResource(mediaGenres[genreType]?.icon ?: R.drawable.ic_nav_categories)
}
...
//        tvGenres.find { it.name == genreName }?.icon ?: R.drawable.ic_nav_categories
//    } else {
//        movieGenres.find { it.name == genreName }?.icon ?: R.drawable.ic_nav_categories
//    }
//}